...
define('CAMPAIGN_ID', "812c52fb7ef4e1b61ff5fa6a031ba0ef");
define('REQUEST_LIVE_TIME', 3600);
define('ENC_KEY', '8437d4e11bc55b851b21cdbd2be05f7c');
define('MP_PARAM_NAME', '_kp_clk');
define('NOT_FOUND_TEXT', '<h1>Page not found</h1>');
define('CHECK_MCPROXY', 0);
define('CHECK_MCPROXY_PARAM', 'b4909203ba833b9db51fae2fb54f6463');
define('CHECK_MCPROXY_VALUE', 'f526cdf9181d99a63f2504a00ec90c22d314df8ef85409591e825344f67a19ab');
