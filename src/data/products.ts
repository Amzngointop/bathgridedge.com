...
export const products: Product[] = [
  ...
  },
  {
    ...
    categorySlug: "vanity-countertop-organizers",
    rank: 8,
    name: "Skincare Organizer with Transparent Dust Cover, White",
    image: "https://m.media-amazon.com/images/I/81JEk9fZWML._AC_SL1500_.jpg",
    summary:
      "The transparent lid sets this organizer apart — it keeps dust and airborne particles off skincare products without hiding what's stored inside.",
    bestFor: "Skincare products sensitive to dust or bathroom humidity",
    pros: [
      "Transparent cover protects products from bathroom dust and spray",
      "Lid lifts away cleanly for full product access",
      "White base and clear lid create a laboratory-clean aesthetic",
      "Effective for open shelving where products collect dust quickly",
    ],
    cons: [
      "Lid adds height that can cause clearance issues on some vanities",
      "Cover requires wiping separately to stay transparent",
    ],
    keyFeature: "Transparent dust cover protects stored skincare",
    topCon: "Added lid height may create clearance issues",
  },
  ...
  },
  {
    ...
    categorySlug: "bath-mats-floor-storage",
    rank: 6,
    name: "BSICPRO 2-Piece Thick Absorbent Chenille Bath Rug Set, Sage",
    image: "https://m.media-amazon.com/images/I/81UhJRF3v3L._AC_SL1500_.jpg",
    summary:
      "A value two-piece set that delivers on absorption and softness at a more accessible cost than single-piece premium alternatives. The sage color is well-chosen for earthy bathroom palettes.",
    bestFor: "Budget-conscious buyers who still want coordinated sets",
    pros: [
      "Two-piece set at a value price point coordinates front-of-tub and toilet areas",
      "Thick chenille absorbs well and feels soft underfoot",
      "Sage green complements natural and organic bathroom themes",
      "Machine washable for easy maintenance",
    ],
    cons: [
      "Backing grip is slightly less aggressive than premium alternatives",
      "Chenille may shed slightly in first few wash cycles",
    ],
    keyFeature: "Value 2-piece sage chenille set",
    topCon: "Grip backing slightly less aggressive than premium mats",
  },
  {
    id: "mat-7",
    asin: "B0G31YQW46",
